...
const Fakultas = () => {
    ...
    return (
        <AppLayout>
            ...
            <ScrollArea className='h-200 w-full whitespace-nowrap rounded-md border'>
            <ScrollBar orientation='horizontal' />
                <Card className='w-full'>
                    ...
                    <CardContent>
                        ...
                        <Tables 
                            head={['Faculty Code', 'Faculty Name', 'Faculty Name (EN)', 'Short Name', 'Faculty Address', 'Phone Number', 'Academic Period', 'Status', 'Vision', 'Mission', 'Description', 'Action']}
                            data={data}
                            columns={['kode_fakultas', 'nama_fakultas', 'nama_fakultas_en', 'nama_singkat_fakultas', 'alamat_fakultas', 'telp_fakultas', 'periode_akademik_id', 'status_fakultas', 'visi_fakultas', 'misi_fakultas', 'ket_fakultas']}
