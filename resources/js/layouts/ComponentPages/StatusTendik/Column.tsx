...
export const columns = (onEdit: (row: StatusTendikType) => void, onDelete: (id: string) => void, selectedIds: number[], toggleSelect: (id: number) => void, toggleSelectAll: (checked: boolean) => void, allSelected: boolean): ColumnDef<StatusTendikType>[] => [
    {
        id: 'select',
        header: ({ table }) => (
            <Checkbox
