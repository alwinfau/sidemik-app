...
export const columns = (onEdit: (row: StatusDosenType) => void, onDelete: (id: string) => void, selectedIds: number[], toggleSelect: (id: number) => void, toggleSelectAll: (checked: boolean) => void, allSelected: boolean): ColumnDef<StatusDosenType>[] => [
    {
        id: 'select',
        header: ({ table }) => (
            <Checkbox
