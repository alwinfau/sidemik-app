    ...
    return (
        <div className="m-6">
            <div className="mb-4 flex justify-between">
                <h2 className="text-2xl font-bold">Jabatan Struktural</h2>
                <div className="flex gap-3">
                    {selectedIds.length > 0 && (
                        <Button
                            variant="destructive"
                            onClick={() => setBulkDeleteOpen(true)}
                            className="flex items-center rounded bg-red-600 p-3 font-bold text-white hover:bg-red-500"
                        >
                            <Trash2 className="h-6 w-6" /> Hapus Terpilih
                        </Button>
                    )}
                    <Button
                        onClick={() => {
                    ...
                    >
                        <CirclePlus className="h-6 w-6" /> Add Jabatan Struktural
                    </Button>
                </div>
            </div>
