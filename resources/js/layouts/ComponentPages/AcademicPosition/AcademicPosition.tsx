...
import { AcademicPositionType, columns } from './Column';
import ModalForm from './Modal';
import { useAcademicPosition } from './useAcademicPosition';

const AcademicPosition = () => {
    const { data, isLoading, toast, fetchData, handleSubmit, handleDelete, setToast, page, setPage, totalPages } = useAcademicPosition();
    const [modalOpen, setModalOpen] = useState(false);
    const [editing, setEditing] = useState<AcademicPositionType | undefined>();
    ...
    return (
        <div className="m-6">
            <div className="mb-4 flex justify-between">
                <h2 className="text-2xl font-bold">Academic Position</h2>
                <Button
                    onClick={() => {
                ...
                >
                    <CirclePlus className="h-6 w-6" /> Add Academic Position
                </Button>
            </div>
