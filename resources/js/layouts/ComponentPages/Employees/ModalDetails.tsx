...
const ModalDetails = ({ open, onOpenChange, defaultValues }: ModalProps) => {
    console.log('defaultValues', defaultValues?.foto);
    return (
                    ...
                    <DialogTitle>{defaultValues ? 'Detail Pegawai' : 'Tambah Pegawai Baru'}</DialogTitle>
                          ...
                          {defaultValues ? (
                            <div className="grid grid-cols-2 gap-5 w-full">
                                <div className="flex flex-col items-center justify-center gap-2 border-r-2 pr-5 bg-gray-50">
                                    <div className="w-50 h-50 bg-gray-300 flex items-center justify-center">
                                          {defaultValues.foto ? <img src={`http://127.0.0.1:8080${defaultValues.foto}`} alt="Foto Pegawai" className="w-full h-full rounded object-cover" /> : <p className="text-gray-500">Tidak ada foto</p>}
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        <p className="font-semibold">Hubungan 1 : </p>
