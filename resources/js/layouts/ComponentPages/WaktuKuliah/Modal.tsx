    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[90vh] overflow-hidden p-6">
                <DialogHeader>
                    <DialogTitle>{defaultValues ? 'Edit Waktu Kuliah' : 'Add Waktu Kuliah'}</DialogTitle>
                </DialogHeader>
                <DialogDescription>Silakan isi data akreditasi Waktu Kuliah dengan lengkap dan sesuai dokumen resmi.</DialogDescription>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mx-3 space-y-4">
                            <FormTextInput
                                ...
                                placeholder="Masukan Waktu Kuliah"
                            />
                            <FormTextInput
                                id="description"
                                label="keterangan"
