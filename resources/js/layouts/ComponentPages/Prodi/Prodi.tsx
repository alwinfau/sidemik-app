...
const Prodi = () => {
    ...
    return (
        <>
            <AppLayout >
                <div className="p-4">
                    <ScrollArea className='h-200 w-400 whitespace-nowrap rounded-md border'>
                    ...
                    <Card className='w-full'>
                        ...
                        <CardContent>
                            ...
                            <Tables
                                head={['Faculty', 'Code Prodi', 'Name Prodi', 'Name Prodi in Eng', 'Short Name of Prodi', 'Education Level Univ', 'Academic period', 'Minimum Passing Credits', 'Minimum Passing Grade', 'Final Project', 'Competency Test', 'Type of Final Project', 'Maximum Lectures', 'Maximum lectures of Examiners', 'Oficial Prodi', 'Prodi Accreditation', 'Prodi Adress', 'Prodi Telphon Number', 'Email Prodi', 'Website Prodi', 'Description Prodi', 'Vision Prodi', 'Mision Prodi', 'Competency Prodi', 'Goals Prodi', 'Action']}
                                data={data}
                                columns={['fakultas_id','kode_ps','nama_ps_id','nama_ps_en','nama_singkat_ps','tinkat_pendidikan_univ_id','periode_akademik_id','sks_lulus_minimal','ipk_lulus_minimal','tugas_akhir_syarat','ukom_syarat','jenis_tugas_akhir_id','max_dosen_pembimbing', 'max_dosen_penguji', 'pejabat_prodi_id', 'akreditasi_prodi_id', 'alamat_prodi', 'telp_prodi', 'alamat_email_prodi', 'alamat_web_prodi', 'deskripsi_prodi', 'visi_prodi', 'misi_prodi', 'kompetensi_prodi', 'capaian_pembelajaran_prodi']}
