...
import { useActiveStatus } from './useActiveStatuses';

const ActiveStatusPages = () => {
    const { data, isLoading, toast, fetchData, handleSubmit, handleDelete, setToast, page, setPage, totalPages } = useActiveStatus();
    ...
    return (
        <div className="m-6">
            <div className="mb-4 flex justify-between">
                ...
                >
                    <CirclePlus className="h-6 w-6" /> Add Active Status
                </Button>
            </div>
...
export default ActiveStatusPages;
